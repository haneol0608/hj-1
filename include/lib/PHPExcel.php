...
class PHPExcel
{
    ...
    */
    ...
    {
        $worksheetCount = count((array)$this->workSheetCollection);
    ...
    public function removeSheetByIndex($pIndex = 0)
    {
        ...
        $numSheets = count((array)$this->workSheetCollection);
        ...
        if (($this->activeSheetIndex >= $pIndex) &&
            ($pIndex > count((array)$this->workSheetCollection) - 1)) {
            --$this->activeSheetIndex;
        }
    ...
    {
        return count((array)$this->workSheetCollection);
    }
    ...
    public function addExternalSheet(PHPExcel_Worksheet $pSheet, $iSheetIndex = null)
    {
        ...
        $countCellXfs = count((array)$this->cellXfCollection);
    ...
    public function addCellXf(PHPExcel_Style $style)
    {
        ...
        $style->setIndex(count((array)$this->cellXfCollection) - 1);
    }
    ...
    {
        if ($pIndex > count((array)$this->cellXfCollection) - 1) {
    ...
    public function addCellStyleXf(PHPExcel_Style $pStyle)
    {
        ...
        $pStyle->setIndex(count((array)$this->cellStyleXfCollection) - 1);
    }
    ...
    {
        if ($pIndex > count((array)$this->cellStyleXfCollection) - 1) {
