              ...
              <tbody>
                <?php
                  ...
                  while($row = mysqli_fetch_assoc($select_result)) {
                    ...
                    // $select_list_query = "SELECT * FROM hj_lada WHERE ho = '$ho' AND por = '$por' AND seq = '$seq' ";
                    // $select_list_result = mysqli_query($conn, $select_list_query);
                    // $select_list_row = mysqli_fetch_assoc($select_list_result);

                    // $list_title = $select_list_row['list_title'];
                    // $qt_no_show = $select_list_row['qt_no'];
                ?>
                ...
                ?>
                  ...
                  <!-- <td><?php echo htmlspecialchars($list_title); ?></td> -->
                </tr>
                <?php
                  }
                ?>
