                        ...
                        <table>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $select_query = "SELECT * FROM hj_pro WHERE $search_type LIKE '%$search%' AND STAT = '절단' ";
                                    } else {
                                    $select_query = "SELECT * FROM hj_pro WHERE STAT = '절단' ORDER BY no DESC ";
                                    }
                                ...
                                <tr>
                                    ...
                                    <input type="hidden" name="ho" value="<?php echo $ho; ?>">
                                    ...
                                    <td>
                                    <input type="button" onclick="pre_input(this)" value="생산이전">
                                    <input type="button" onclick="next_pro_1(this)" value="벤딩">
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
