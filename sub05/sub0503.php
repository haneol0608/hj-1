                        ...
                        <table>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $select_query = "SELECT * FROM hj_pro WHERE $search_type LIKE '%$search%' AND STAT = '취부' ";
                                    } else {
                                    $select_query = "SELECT * FROM hj_pro WHERE STAT = '취부' ORDER BY no DESC ";
                                    }
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <input type="button" onclick="pre_pro_2(this)" value="벤딩">
                                    <input type="button" onclick="next_pro_3(this)" value="용접">
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
