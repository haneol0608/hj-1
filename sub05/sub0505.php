                            ...
                            <tbody>
                                <?php
                                    ...
                                    if($search_type && $search) {
                                        $select_query = "SELECT * FROM hj_pro WHERE $search_type LIKE '%$search%' AND STAT = '사상' ";
                                    } else {
                                        $select_query = "SELECT * FROM hj_pro WHERE STAT = '사상' ORDER BY no DESC ";
                                    }
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="button" onclick="pre_pro_4(this)" value="용접">
