                        ...
                        <table>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $select_query = "SELECT * FROM hj_pro WHERE $search_type LIKE '%$search%' AND STAT = '벤딩' ";
                                    } else {
                                    $select_query = "SELECT * FROM hj_pro WHERE STAT = '벤딩' ORDER BY no DESC ";
                                    }
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <input type="button" onclick="pre_pro_1(this)" value="절단">
                                    <input type="button" onclick="next_pro_2(this)" value="취부">
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
