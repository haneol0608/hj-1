        ...
        <div class="sub_plate">
          ...
          <div class="code_list">
            ...
            <table class="<?php echo $style; ?>">
              ...
              <tbody>
                <?php
                    $select_query2 = "SELECT * FROM hj_shipment WHERE stat = '송장출력' $search_str";
                ...
                <tr>
                  ...
                  <td>
                    <input type="button" onclick="location.href = '/hj/sub14/sub1405_print.php?no=' + <?php echo $no; ?>;" value="선택">
                  </td> 
                </tr>
                <?php } ?>
              </tbody>
