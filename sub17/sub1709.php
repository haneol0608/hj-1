...
<?php
  ...
  if($s_user_power) { 
    $search_str .= " AND user_power = '$s_user_power' "; 
  }
?>
  ...
  <div class="ct_wrap">
    ...
    <div class="container_ct">
      ...
      <!--***************** 20232-03-28. 김한얼 팀장. 시정조치 보완요청 사항 반엉 *****************-->
        <div class="sub_plate">
            <h3>사용화면 검색</h3>
            <form action="<?php  echo $_SERVER['PHP_SELF'] . '?s_user_name=' . $s_user_name . '&s_user_power=' . $s_user_power; ?>">
                <table>
                    <tr>
                        <td>성명</td>
                        <td>
                        ...
                        <td>사용화면</td>
                        <td>
                            <select style="width: 90%;" name="s_user_power">
                                <option value="">----</option>
                                <option <?php if($s_user_power == '관리') {echo "selected"; } ?> value="관리">화면2</option>
                                <option <?php if($s_user_power == '사원') {echo "selected"; } ?> value="사원">화면1</option>
                            </select>
                        </td>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <label>현재 화면 : <?php if($user_power == '관리') {echo "화면2";} else {echo "화면1";} ?><br></label>
                    <?php if($user_power == "관리") { ?>
                      <input type="radio" name="up_user_power" value="사원"><label>화면1</label>
                    <?php } ?>
                    <?php if($user_power == "사원") { ?>
                    <input type="radio" name="up_user_power" value="관리"><label>화면2</label>
                    <?php } ?>
                  </td>
                  <td>
