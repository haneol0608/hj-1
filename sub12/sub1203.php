        ...
        <div class="sub_plate">
          ...
          <div class="drawing_table">
            <table>
              ...
              <tbody>
                <?php
                  $select_query = "SELECT * FROM hj_cutting AS A JOIN hj_quantity AS B ON A.por = B.por AND A.ho = B.ho AND A.seq = B.seq $search_str LIMIT 40";
                ...
                <tr>
                  ...
                  <td>
                    <input type="button" onclick="quan_del('<?php echo $ho; ?>', '<?php echo $por; ?>', '<?php echo $seq; ?>');" value="삭제">
                  </td>
                </tr>
                <?php
                  }
