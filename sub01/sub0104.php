              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $p; ?></td>
                    <td>
                      <input type="button" onclick="location.href='sub0104_frame.php?w=<?php echo $w; ?>&p=<?php echo $p; ?>&lot_date=<?php echo $enc_lotDate; ?>&list_lot=<?php echo $enc_listLot; ?>'" value="프레임 상세조회">
          ...
          <div class="drawing_table">
            <table>
              ...
              <tbody>
                <tr>
                  <td>
                    <input type="button" onclick="location.href='sub0104_leg.php?w=<?php echo $w; ?>&p=<?php echo $p; ?>&lot_date=<?php echo $enc_lotDate; ?>&list_lot=<?php echo $enc_listLot; ?>'" value="다릿발 상세조회">
                  </td>
                </tr>
              </tbody>
            </table>
