<?php
  ...
  $i = -1;
  $select_query = "SELECT * FROM hj_prolist AS A, hj_cutting AS B WHERE (B.w = '$w' AND B.p= '$p' AND A.lot_date = '$lot_date' AND A.list_lot = '$list_lot') AND (A.ho = B.ho AND A.por = B.por AND A.seq = B.seq)
  ORDER BY A.qt_no * '1' ASC, A.qt_no ASC, A.qt_no ASC, A.seq ASC, B.count DESC ";
